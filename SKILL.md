...
- 博客语气应当娓娓道来、深入浅出：先讲宏观结构，再讲机制，最后回到方法关系和核心认识。
- 避免 AI 讲义口吻，不写“教读者怎么看论文”的提示式表达；用知识体系、问题脉络和系统演化来组织文章。
- 这是作者用于自我总结和自我学习的技术博客，也面向技术背景相近、希望弄清问题来龙去脉的读者；正文应解释机制和关系，不把文章写成给读者布置实践任务的指南。
- 标题不要使用套路化的“从 XXX 到 XXX”范式，也避免使用冒号连接标题层次；论文、书籍和其他作品的标题保留原文，不做中文翻译。
- 少用套路句式，尤其避免习惯性的“不是……而是……”“把 X 放进 Y”等表达。
- 使用陈述式标题和正文，避免反复采用提问再回答的结构；用“小结”“方法关系”“核心认识”等表达总结内容，不使用“实践启示”式的指导口吻。
